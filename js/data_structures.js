...
this.drive = function() { console.log("And you're off!"); };
...
console.log("Now you're set, how about a family car...");
var familyCar = new Car("Toyota", "gray", "minivan");
console.log(familyCar);
console.log("This car can hold eight!:");
