...
#STATE DATA is a hash.  
#SATE DATA is also in ALL CAPS making it a constant.
...
#for the entire name.  MYCONSTANT = "plasma physics"
#Scope defines where a variable is accessible: local, global, 
#instance, and class. A CONSTANT scope declared within a class or module are
#avialable anywhere within the context of that class or module.
#Constants declared outside of a class or module are assigned global scope.
#Onse assigned they should not be changed.
